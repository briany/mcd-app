...
struct MarkdownParser {
    ...
    static func parseMyCoupons(_ markdown: String) -> [Coupon] {
        var coupons: [Coupon] = []
    ...
    static func parseAvailableCoupons(_ markdown: String) -> [Coupon] {
        var coupons: [Coupon] = []
    ...
    static func parseCampaigns(_ markdown: String, for date: String) -> [Campaign] {
